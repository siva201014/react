...
import updateBillingData from "../api/updateBillingData.js";
...
export const LoginPage = () => {
    ...
    return (
        ...
        <div class="flex-container login-container">
            <div class="flex-item inside-form login-entry">
                <h1>Please Login</h1>
                ...
                <button onClick={()=>handleClick()} type="button" class="btn btn-success">Login with GitHub</button>
            </div>
        </div>
